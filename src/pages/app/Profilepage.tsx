...
const Profilepage = () => {
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-5 p-4 sm:p-5 lg:p-6">
                ...
                <div className="flex flex-col justify-between gap-5 border-b border-slate-800 pb-5 sm:flex-row sm:items-center">
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-blue-600 text-2xl font-semibold text-white">
                                {myProfile.data?.profile_picture ? (
                                    <img
                                        src={myProfile.data.profile_picture}
                                        alt="Profile"
                            ...
                            <button
                                ...
                                className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-[#151a21] bg-blue-600 text-white shadow-md transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-60"
                            >
            ...
            {/* KEEP EVERYTHING BELOW THIS EXACTLY AS YOUR CURRENT CODE */}
